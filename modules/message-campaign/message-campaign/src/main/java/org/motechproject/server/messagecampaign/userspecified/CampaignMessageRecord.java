...
public class CampaignMessageRecord {
    ...
    private CampaignMessage buildDayOfWeekCampaignMessage() {
        DayOfWeekCampaignMessage message = new DayOfWeekCampaignMessage(
                getDaysOfWeek(repeatOn));
        message.name(name()).formats(formats()).languages(languages())
    ...
    private CampaignMessage buildRepeatIntervalCampaignMessage() {
        RepeatIntervalCampaignMessage message = new RepeatIntervalCampaignMessage(
                new TimeIntervalParser().parse(repeatInterval()));
        message.name(name()).formats(formats()).languages(languages())
                .messageKey(messageKey());
        // .setStartTime(parseTime(startTime, ":"));
        return message;
    ...
    /*
     * public CampaignMessageRecord startTime(String startTime) { this.startTime
