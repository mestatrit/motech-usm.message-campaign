package org.motechproject.couch.mrs.osgi;
...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationCouchMRSBundle.xml";
    private static final String SERVLET_URL_MAPPING = "/couchmrs";
    ...
    public static class CouchMRSApplicationContext extends OsgiBundleXmlWebApplicationContext {

        public CouchMRSApplicationContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(CouchMRSApplicationContext.class);
