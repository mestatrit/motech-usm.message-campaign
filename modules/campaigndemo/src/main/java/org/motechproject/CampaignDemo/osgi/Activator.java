...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "campaignDemoResourcesBundle.xml";
    private static final String SERVLET_URL_MAPPING = "/campaigndemo/api";
    ...
    public static class CampaignDemoApplicationContext extends OsgiBundleXmlWebApplicationContext {

        public CampaignDemoApplicationContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(CampaignDemoApplicationContext.class);
            ClassLoader old = Thread.currentThread().getContextClassLoader();
            try {
                Thread.currentThread().setContextClassLoader(getClass().getClassLoader());
                
                CampaignDemoHttpContext httpContext = new CampaignDemoHttpContext(service.createDefaultHttpContext());
